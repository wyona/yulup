...
WYSIWYGModeView.prototype = {
    ...
    setUp: function () {
        ...
        try {
            ...
            dump("################################## load URI = \"" + this.model.documentReference.getLoadURI() + "\"\n");

            // hook up an onlocationChanged observer
            this.editor.commandManager.addCommandObserver(new LocationChangedObserver(this.view), "obs_documentLocationChanged");
    ...
    fillView: function () {
        ...
        try {
            ...
            /* DEBUG */ dump("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& Yulup:view.js:LocationChangedObserver.observe: calling updateBaseURL()\n");
            this.view.updateBaseURL();
...
function LocationChangedObserver(aView) {
    /* DEBUG */ dump("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& Yulup:view.js:LocationChangedObserver(\"" + aView + "\") invoked\n");

    this.view = aView;
}

LocationChangedObserver.prototype = {
    view: null,

    observe: function (aSubject, aTopic, aData) {
        /* DEBUG */ dump("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& Yulup:view.js:LocationChangedObserver.observe(\"" + aSubject + "\", \"" + aTopic + "\", \"" + aData + "\") invoked\n");

        if (aTopic == "obs_documentLocationChanged") {
            /* DEBUG */ dump("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& Yulup:view.js:LocationChangedObserver.observe: calling updateBaseURL()\n");
            this.view.updateBaseURL();
        }
    }
